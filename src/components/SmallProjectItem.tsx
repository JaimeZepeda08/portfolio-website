...
const SmallProjectItem: React.FC<SmallProjectItemProps> = ({
  ...
  return (
    <div className="group relative flex-col h-[20rem] p-5 bg-green-900/40 rounded-md shadow-sm transition-transform duration-300 ease-in-out hover:-translate-y-2 hover:shadow-xl">
